package ru.mirea.tyve.notebook;
...
public class MainActivity extends AppCompatActivity {
    ...
    final String SAVED_TEXT = "filename";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        multiLine.setText(getTextFromFile(fileName));
        Toast.makeText(this, "Text loaded", Toast.LENGTH_SHORT).show();
    }

    public void onSaveClick(View view) {
        fileName = ((EditText) findViewById(R.id.editText_Name)).getText().toString();
        String string = ((EditText) findViewById(R.id.multiLine)).getText().toString();
